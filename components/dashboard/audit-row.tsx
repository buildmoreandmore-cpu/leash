...
export function AuditRow({
  ...
  const content = (
    <div className="flex items-center gap-3 rounded-lg border border-border-leash/50 bg-surface/50 px-3 py-2 text-sm transition-colors hover:bg-surface-hover/50">
      {/* Timestamp */}
