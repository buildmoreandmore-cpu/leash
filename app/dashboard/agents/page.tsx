    ...
    <div className="space-y-6">
      ...
      <div className="overflow-x-auto rounded-xl border border-border-leash bg-surface">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border-leash/50 text-left text-xs text-text-muted">
            ...
            {filtered.map((agent, i) => {
              ...
              return (
                <motion.tr
                  ...
                  className="cursor-pointer border-b border-border-leash/30 transition-colors hover:bg-surface-hover/50"
                >
                  {/* Name + status dot */}
                  ...
                  <td className="px-4 py-3">
                    <div className="relative">
                      ...
                      {menuOpen === agent.id && (
                        <div className="absolute right-0 top-8 z-10 w-36 rounded-lg border border-border-leash bg-surface py-1 shadow-lg">
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
