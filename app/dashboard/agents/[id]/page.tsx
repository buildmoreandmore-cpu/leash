        ...
        <TabsContent value="overview">
          <div className="mt-4 space-y-6">
            ...
            <div className="rounded-xl border border-border-leash bg-surface">
              <div className="border-b border-border-leash/50 px-4 py-3">
                ...
                {scopes.length > 0 ? (
                  scopes.map((s, i) => (
                    <motion.div
                      ...
                      className="flex items-center justify-between rounded-lg border border-border-leash/50 bg-background/50 px-3 py-2"
                    >
                      <ScopeBadge scope={s} />
                      <button
                        onClick={() =>
