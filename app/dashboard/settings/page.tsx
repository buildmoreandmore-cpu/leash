        ...
        <div className="flex items-center justify-between border-b border-border-leash/50 px-4 py-3">
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="sm:max-w-md">
              ...
              <div className="flex items-center gap-2 rounded-lg border border-border-leash bg-background/50 p-3">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {keys.map((k) => (
                <tr
                  key={k.id}
                  className="border-b border-border-leash/30 transition-colors hover:bg-surface-hover/50"
                >
